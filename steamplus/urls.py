...
urlpatterns = [
    ...
    path('play/status/', views.play_status, name='play_status'),
    path('play/<int:game_id>/', views.play_game, name='play_game'),
    path('play/<int:game_id>/start/', views.play_session_start, name='play_session_start'),
    path('play/<int:game_id>/heartbeat/', views.play_session_heartbeat, name='play_session_heartbeat'),
    path('play/<int:game_id>/end/', views.play_session_end, name='play_session_end'),
